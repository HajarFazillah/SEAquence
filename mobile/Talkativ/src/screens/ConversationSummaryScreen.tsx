...
// Mock summary data (will come from AI)
const mockSummary = {
  scores: {
    speechAccuracy: 0.72,
    vocabulary: 0.65,
  ...
  mistakes: [
    ...
    },
    {
      original: '맛있는 먹었어요',
      correction: '맛있게 먹었어요',
      explanation: '"맛있는"은 형용사이고, "맛있게"는 부사입니다. 동사를 수식할 때는 부사를 사용해야 합니다.',
      type: 'grammar' as const,
    },
  ],
  vocabularyToLearn: [
    ...
    { word: '괜찮아요', meaning: "It's okay / I'm fine", example: '걱정 마세요, 괜찮아요.' },
    { word: '잠시만요', meaning: 'Just a moment', example: '잠시만요, 확인해볼게요.' },
  ],
  phrasesToLearn: [
    ...
    { word: '잘 부탁드립니다', meaning: 'Please take care of it / Nice to meet you', example: '처음 뵙겠습니다. 잘 부탁드립니다.' },
  ],
  improvements: [
    '존댓말 사용이 많이 좋아졌어요!',
    '문장 구조가 자연스러워지고 있어요.',
  ...
  suggestions: [
    '조사 사용을 더 연습해보세요 (은/는, 이/가, 을/를)',
    '격식체와 비격식체의 차이를 공부해보세요',
  ],
};
...
export default function ConversationSummaryScreen() {
  ...
  const handleSaveAll = () => {
    ...
    setSavedItems(new Set(allItems));
